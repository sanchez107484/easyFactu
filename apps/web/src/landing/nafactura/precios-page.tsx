  ...
  '@graph': [
    {
      ...
      description: `Software de facturación para autónomos navarros. Gratis hasta 2027, luego ${PRICING.starter.monthly}€/mes o ${PRICING.starter.annualMonthly}€/mes con pago anual. Sin tarjeta al registrarte. Hasta 60 facturas al año.`,
    ...
    },
    {
      ...
      description: `Software de facturación para autónomos navarros. Gratis hasta 2027, luego ${PRICING.pro.monthly}€/mes o ${PRICING.pro.annualMonthly}€/mes con pago anual.`,
      brand: { '@type': 'Brand', name: brandConfig.app.name },
      offers: [
        {
          '@type': 'Offer',
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: `Tienes dos planes: Plan Starter a ${PRICING.starter.monthly}€/mes con hasta 60 facturas al año, y Plan PRO a ${PRICING.pro.monthly}€/mes con facturas ilimitadas. Sin permanencia.`,
          },
        },
        {
          '@type': 'Question',
          name: '¿Funciona para autónomos navarros con Hacienda Foral?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: `Sí. ${brandConfig.app.name} está diseñado específicamente para autónomos navarros, incluye los tipos impositivos de Navarra y cumple con los requisitos de Hacienda Foral de Navarra.`,
          },
        },
      ],
    },
...
const sharedFeatures = [
  ...
  { text: 'Adaptado para Navarra', icon: BadgeCheck },
...
const testimonials = [
  {
    ...
    location: 'Pamplona',
    text: 'Llevo 4 meses usando NaFactura y ya no me preocupa Hacienda Navarra. El período gratuito me dio tiempo de comprobarlo antes de comprometerme. No volvería a Excel.',
    stars: 5,
    initials: 'AG',
  ...
  },
  {
    ...
    location: 'Tudela',
    text: 'Probé otros programas y ninguno estaba adaptado para Navarra. Con NaFactura todo cuadra: tipos impositivos, Hacienda Foral... y el precio es justo.',
    stars: 5,
    initials: 'JI',
...
const faqs = [
  {
    ...
    a: `Tienes dos planes: Plan Starter a ${PRICING.starter.monthly}€/mes (${PRICING.starter.annualMonthly}€/mes anual) con hasta 60 facturas al año, y Plan PRO a ${PRICING.pro.monthly}€/mes (${PRICING.pro.annualMonthly}€/mes anual) con facturas ilimitadas. Sin permanencia.`,
  },
  {
    q: '¿Funciona para autónomos navarros con Hacienda Foral?',
    a: `Sí. ${brandConfig.app.name} está diseñado específicamente para autónomos navarros. Incluye los tipos impositivos de Navarra y cumple con los requisitos de Hacienda Foral de Navarra y el sistema VeriFactu de la AEAT.`,
  },
  {
    q: '¿Cuál es la diferencia entre Plan Starter y Plan PRO?',
    a: `Ambos planes incluyen VeriFactu automático y cumplimiento con Hacienda Navarra. La diferencia es el límite de facturas: Starter hasta 60 al año, PRO ilimitadas.`,
  },
  {
...
function FaqItem({ q, a, index }: { q: string; a: string; index: number }) {
  ...
  return (
    <div
      className={`rounded-2xl border-2 bg-white transition-all duration-200 ${open ? 'border-red-200 shadow-md shadow-red-50' : 'border-slate-100 hover:border-slate-200'}`}
    >
      <button
      ...
      >
        ...
        <ChevronDown
          className={`mt-0.5 h-5 w-5 shrink-0 text-slate-400 transition-transform duration-300 ${open ? 'rotate-180 text-red-500' : ''}`}
        />
      </button>
      <div
  ...
  return (
    <div className="flex items-center justify-center gap-3">
      ...
      <button
        ...
        className={`relative inline-flex h-7 w-14 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none ${annual ? 'bg-red-600' : 'bg-slate-200'}`}
        role="switch"
        aria-checked={annual}
...
export function NafacturaPreciosPage(): React.JSX.Element {
        ...
        <main className="flex-1">
          ...
          <section className="pb-0 pt-16 md:pt-24">
            <div className="mx-auto max-w-4xl px-4 text-center">
              <div
                className="mb-5 inline-flex items-center gap-2.5 rounded-full px-5 py-2 text-sm font-semibold text-white shadow-sm"
                style={{
              ...
              <h1 data-speakable className="mb-5 text-4xl font-extrabold leading-tight tracking-tight text-slate-900 sm:text-5xl md:text-6xl">
                <span className="block text-slate-500 text-2xl font-semibold mb-2 sm:text-3xl">
                  Precio de {brandConfig.app.name} para Navarra
                </span>
              ...
              <p className="mx-auto mb-8 max-w-2xl text-lg text-slate-500 sm:text-xl leading-relaxed">
                ...
                <strong className="text-slate-800">Diseñado para autónomos navarros.</strong>
              </p>

              <div className="mb-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                <Link
                  href="/registro"
                  className="group flex h-14 w-full items-center justify-center gap-2.5 rounded-2xl bg-red-600 px-10 text-base font-bold text-white shadow-xl shadow-red-200 transition-all duration-200 hover:bg-red-700 hover:shadow-2xl hover:-translate-y-0.5 sm:w-auto"
                >
                ...
                <Link
                  href="/contacto"
                  className="flex h-14 w-full items-center justify-center gap-2 rounded-2xl border-2 border-slate-200 bg-white px-8 text-base font-semibold text-slate-700 transition-all hover:border-red-200 hover:text-red-600 sm:w-auto"
                >
                  Tengo una pregunta
                </Link>
              </div>
              ...
              <div className="mb-12 flex flex-wrap items-center justify-center gap-x-6 gap-y-2.5 text-sm text-slate-500">
                {[
                  ...
                  { icon: Shield, text: 'Adaptado Navarra' },
                  { icon: Lock, text: 'RGPD compliant' },
                  { icon: BadgeCheck, text: 'Hacienda Navarra' },
                ].map(({ icon: Icon, text }) => (
            ...
            <div className="mx-auto max-w-5xl px-4 pb-0">
              ...
              <div className="grid gap-6 lg:grid-cols-2 items-start">
                  ...
                  <div className="p-8">
                    <div className="mb-6">
                      ...
                      <p className="mt-1 text-sm text-slate-500 leading-snug">
                        Hacienda Navarra incluida. Perfecto para autónomos navarros con actividad
                        moderada.
                      </p>
                ...
                {/* PRO CARD */}
                <div className="relative overflow-hidden rounded-3xl border-2 border-red-300 bg-gradient-to-br from-white to-red-50 shadow-2xl shadow-red-100">
                  <div className="h-1.5 w-full bg-gradient-to-r from-red-500 via-orange-500 to-red-600" />
                  <div className="absolute top-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-gradient-to-r from-red-600 to-orange-600 px-5 py-1.5 text-xs font-bold text-white shadow-md">
                  ...
                  <div className="p-8 pt-12">
                    <div className="mb-6">
                      ...
                      <p className="mt-1 text-sm text-slate-500 leading-snug">
                        Facturas ilimitadas con cumplimiento Hacienda Navarra y tranquilidad fiscal
                    ...
                    <Link
                      ...
                      className="group flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-red-600 text-sm font-bold text-white shadow-lg shadow-red-200 transition-all hover:bg-red-700 hover:shadow-xl hover:-translate-y-0.5 mb-3"
                    >
          ...
          <section ref={statsRef} className="border-y border-slate-100 bg-slate-50 py-12">
            <div className="mx-auto max-w-4xl px-4">
              <div className="grid gap-8 sm:grid-cols-3 text-center">
                <div>
                  <div className="text-5xl font-black text-red-600 tabular-nums">2027</div>
                ...
                <div>
                  ...
                  <p className="mt-1.5 font-semibold text-slate-700">
                    autónomos navarros ya inscritos
                  </p>
                  <p className="text-sm text-slate-400">Autónomos y pymes de toda Navarra</p>
                </div>
                <div>
          ...
          <section className="py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4">
              <div className="mb-3 text-center">
                <span className="inline-flex items-center gap-1.5 rounded-full border border-red-100 bg-red-50 px-3 py-1 text-xs font-semibold text-red-700">
                  Starter vs PRO
                </span>
              </div>
              ...
              <p className="mx-auto mb-10 max-w-xl text-center text-slate-500">
                ...
                <strong className="text-slate-700">cumplimiento Hacienda Navarra</strong> y
                VeriFactu. La única diferencia es el número de facturas.
              </p>
                ...
                <div className="rounded-2xl border-2 border-slate-200 bg-white p-6">
                  ...
                  <ul className="space-y-2 text-sm text-slate-600">
                    {[
                      ...
                      'VeriFactu + Hacienda Navarra incluido',
                    ].map((t) => (
                  ...
                  <p className="mt-4 rounded-lg bg-slate-50 p-2.5 text-xs text-slate-500 text-center">
                    Ideal para autónomos navarros con actividad moderada
                  </p>
                </div>
                <div className="relative rounded-2xl border-2 border-red-300 bg-red-50 p-6">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-gradient-to-r from-red-600 to-orange-600 px-4 py-1 text-xs font-bold text-white shadow-sm">
                    ⭐ Recomendado
                  </div>
                  ...
                  <p className="mt-4 rounded-lg bg-red-100 p-2.5 text-xs text-red-700 text-center font-semibold">
                    Sin límite de facturas · Para negocios navarros en crecimiento
                  </p>
                </div>
              </div>
              <p className="mt-6 text-center text-xs text-slate-400">
          ...
          <section className="border-y border-slate-100 bg-slate-50 py-16 md:py-24">
            <div className="mx-auto max-w-5xl px-4">
              ...
              <h2 className="mb-4 text-center text-3xl font-extrabold text-slate-900 sm:text-4xl">
                ...
                <span className="text-red-600">no tener problemas con Hacienda</span>
              </h2>
              <p className="mx-auto mb-12 max-w-2xl text-center text-slate-500">
                Compara el precio de {brandConfig.app.name} con el coste real de no cumplir con las
                obligaciones fiscales en Navarra.
              </p>
              <div className="grid gap-6 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={item.label}
                    className={`relative overflow-hidden rounded-2xl border-2 p-6 text-center ${item.negative ? (item.color === 'red' ? 'border-red-100 bg-red-50' : 'border-amber-100 bg-amber-50') : 'border-red-200 bg-gradient-to-br from-red-600 to-red-700 text-white shadow-xl shadow-red-200'}`}
                  >
                    <item.icon
                      className={`mx-auto mb-3 h-8 w-8 ${item.negative ? (item.color === 'red' ? 'text-red-400' : 'text-amber-400') : 'text-red-200'}`}
                    />
                    <p
                      className={`mb-1 text-xs font-semibold uppercase tracking-wide ${item.negative ? (item.color === 'red' ? 'text-red-400' : 'text-amber-500') : 'text-red-200'}`}
                    >
                      {item.label}
                    </p>
                    <div
                    ...
                    <p
                      className={`mt-1.5 text-xs leading-snug ${item.negative ? (item.color === 'red' ? 'text-red-400' : 'text-amber-500') : 'text-red-200'}`}
                    >
                      {item.sub}
                    </p>
                    {!item.negative && (
                      <div className="mt-4">
                        <Link
                          href="/registro"
                          className="inline-flex items-center gap-1.5 rounded-xl bg-white px-4 py-2 text-sm font-bold text-red-600 transition-colors hover:bg-red-50"
                        >
                          Empezar gratis
                          <ArrowRight className="h-4 w-4" />
                        </Link>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b-2 border-slate-100 bg-slate-50">
                      ...
                      <th className="bg-red-50 px-3 py-4 text-center font-bold text-red-700">
                        PRO
                      </th>
          ...
          <section className="border-y border-slate-100 bg-slate-50 py-16 md:py-24">
            <div className="mx-auto max-w-6xl px-4">
              ...
              <h2 className="mb-3 text-center text-3xl font-extrabold text-slate-900 sm:text-4xl">
                Lo que dicen autónomos navarros
              </h2>
              <p className="mx-auto mb-12 max-w-xl text-center text-slate-500">
                Más de {PLAZAS_CONFIG.ocupadas.toLocaleString('es-ES')} autónomos navarros confían
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {testimonials.map((t) => (
                  <div
                    key={t.name}
                    className="group relative flex flex-col rounded-2xl border-2 border-slate-100 bg-white p-6 shadow-sm transition-all hover:border-red-100 hover:shadow-lg"
                  >
          ...
          <section className="py-16 md:py-24">
            <div className="mx-auto max-w-3xl px-4">
              ...
              <p className="mx-auto mb-10 max-w-xl text-center text-slate-500">
                ...
                <Link
                  href="/contacto"
                  className="font-semibold text-red-600 underline underline-offset-2 hover:no-underline"
                >
          ...
          <section className="relative overflow-hidden border-t border-slate-100 bg-slate-50 py-20 md:py-28">
            <div
              ...
              style={{
                background:
                  'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(220,38,38,0.05) 0%, transparent 70%)',
              }}
            />
            <div className="pointer-events-none absolute -left-20 top-10 h-80 w-80 rounded-full bg-red-100 opacity-20 blur-3xl" />
            <div className="pointer-events-none absolute -right-20 bottom-10 h-80 w-80 rounded-full bg-orange-100 opacity-20 blur-3xl" />
            <div className="relative mx-auto max-w-3xl px-4 text-center">
              ...
              <h2 className="mb-4 text-4xl font-extrabold text-slate-900 sm:text-5xl leading-tight">
                Empieza gratis hoy.
                <br />
                <span className="text-red-600">Gratis hasta 2027, sin compromiso.</span>
              </h2>

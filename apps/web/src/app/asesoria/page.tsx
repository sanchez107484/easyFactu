...
export const metadata: Metadata = {
  title: `Para asesorías y gestorías | ${brandConfig.app.name}`,
  description:
    'Gestiona la facturación de todos tus clientes desde un único panel. VeriFactu automático. Completamente gratis para asesorías.',
};

  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/40 p-4">
      <Card className="w-full max-w-md">
        ...
        {hasCorruptedTokens && (
          <div className="mx-6 mb-4 rounded-lg border border-proforma-200 bg-proforma-50 p-3">
            <div className="flex items-start gap-2">
              <AlertCircle className="h-5 w-5 text-proforma-600 flex-shrink-0 mt-0.5" />
              <div className="flex-1 space-y-2">
                <p className="text-sm text-proforma-800">

...
function StyleTab({
  ...
  return (
    <>
      ...
      <FieldGroup title="Tamaño de letra">
    ...
    <>
      <FieldGroup title="Logo">
        {logoUrl ? (
          <div className="flex items-center gap-3 rounded-lg border bg-muted/40 p-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] text-muted-foreground">Cámbialo en Ajustes ? Empresa</div>
            </div>
          </div>
        ) : (
        ...
        {layout.logo.visible && (
          <>
            <div>
              <p className="mb-2 text-xs font-medium">Posición del logo</p>
            ...
            <div className="space-y-1">
              <div className="flex justify-between">
                <span className="text-xs font-medium">Tamaño del logo</span>
                <span className="text-xs font-semibold tabular-nums text-primary">
      ...
      <FieldGroup title="Disposición" description="Lado donde aparecen tus datos de empresa">
        <div className="grid grid-cols-2 gap-2">
          {(
            [
              { value: 'left', label: 'Tú a la izquierda' },
              { value: 'right', label: 'Tú a la derecha' },
            ] as const
          ).map((side) => {
      ...
      <FieldGroup title="Columnas visibles">
        <div className="divide-y">
          <ToggleRow
            ...
            description="Muestra el código de cada artículo"
  ...
  return (
    <>
      <FieldGroup title="Notas">
        <div className="divide-y">
          <ToggleRow
            label="Mostrar sección de notas"
        ...
        {layout.notes?.show !== false && (
          <div>
            ...
            <p className="mt-1 text-[11px] text-muted-foreground">
              Se usará en nuevas facturas por defecto
            </p>
          </div>
        )}
      </FieldGroup>
